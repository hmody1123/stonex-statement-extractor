...
if uploaded_files:
    ...
    with tabs[1]:
        ...
        group_by_cols = st.multiselect(
            ...
            default=["statement_date", "account_number", "exchange", "product", "option_type", "ref_month", "strike", "unit"],
    ...
    with tabs[5]:
        display_custom_table(
            ...
            default_columns=[
                "card", "account_type", "exchange", "product", "product_name", "quantity", "contract_month", "contract_year",
